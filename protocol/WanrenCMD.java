...
public class WanrenCMD {
	...
	public class REQ {
		...
		public final static int GRAB_HOST = 0x08;
		// public final static int FOLLOW_BET = 0x09;
		public final static int MULTIPLY = 0x0A;
		public final static int SHOW_CARDS = 0x0B;
		...
		public final static int TABLE_LOGIN_EX = 0x21;
	...
	public class RCV {
		...
		public final static int START_GRAB_HOST = 0x4A;
		public final static int START_MULTIPLY = 0x4B;
		public final static int START_SHOW_CARDS = 0x4C;
		public final static int PLAYER_READY = 0x4D;
		public final static int PLAYER_GRAB_HOST = 0x4E;

		public final static int PLAYER_MULTIPLY = 0x50;
		public final static int PLAYER_SHOW_CARDS = 0x51;
